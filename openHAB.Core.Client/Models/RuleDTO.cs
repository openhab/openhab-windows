...
namespace openHAB.Core.Client.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the RuleDTO class.
        /// </summary>
        public RuleDTO()
        {
            CustomInit();
        ...
        /// 'HIDDEN', 'EXPERT'</param>
        public RuleDTO(IList<TriggerDTO> triggers = default(IList<TriggerDTO>), IList<ConditionDTO> conditions = default(IList<ConditionDTO>), IList<ActionDTO> actions = default(IList<ActionDTO>), IDictionary<string, object> configuration = default(IDictionary<string, object>), IList<ConfigDescriptionParameterDTO> configDescriptions = default(IList<ConfigDescriptionParameterDTO>), string templateUID = default(string), string uid = default(string), string name = default(string), IList<string> tags = default(IList<string>), string visibility = default(string), string description = default(string))
        {
            Triggers = triggers;
