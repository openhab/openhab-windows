...
namespace openHAB.Core.Client.Models
{
    ...
    public partial class Template
    {
        ...
        /// 'HIDDEN', 'EXPERT'</param>
        public Template(string visibility = default(string), IList<string> tags = default(IList<string>), string uid = default(string), string label = default(string), string description = default(string))
        {
