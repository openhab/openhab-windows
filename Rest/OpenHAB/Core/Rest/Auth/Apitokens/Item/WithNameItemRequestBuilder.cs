...
namespace OpenHAB.Core.Rest.Auth.Apitokens.Item {
    ...
    public class WithNameItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithNameItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/auth/apitokens/{name}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="WithNameItemRequestBuilder"/> and sets the default values.
        /// </summary>
