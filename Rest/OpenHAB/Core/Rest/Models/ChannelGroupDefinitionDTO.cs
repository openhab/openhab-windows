...
namespace OpenHAB.Core.Rest.Models {
    public class ChannelGroupDefinitionDTO : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ChannelGroupDefinitionDTO"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ChannelGroupDefinitionDTO"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ChannelGroupDefinitionDTO CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ChannelGroupDefinitionDTO();
        }
        /// <summary>
