...
namespace OpenHAB.Core.Rest.Models {
    public class ChannelDTO : IAdditionalDataHolder, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ChannelDTO_configuration? Configuration { get; set; }
#nullable restore
#else
        public ChannelDTO_configuration Configuration { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ChannelDTO_properties? Properties { get; set; }
#nullable restore
#else
        public ChannelDTO_properties Properties { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ChannelDTO"/> and sets the default values.
        /// </summary>
        public ChannelDTO() {
        ...
        /// </summary>
        /// <returns>A <see cref="ChannelDTO"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ChannelDTO CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"configuration", n => { Configuration = n.GetObjectValue<ChannelDTO_configuration>(ChannelDTO_configuration.CreateFromDiscriminatorValue); } },
                ...
                {"properties", n => { Properties = n.GetObjectValue<ChannelDTO_properties>(ChannelDTO_properties.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ChannelDTO_configuration>("configuration", Configuration);
            ...
            writer.WriteObjectValue<ChannelDTO_properties>("properties", Properties);
