...
namespace OpenHAB.Core.Rest.Models {
    public class Condition : IAdditionalDataHolder, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Condition_inputs? Inputs { get; set; }
#nullable restore
#else
        public Condition_inputs Inputs { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="Condition"/> and sets the default values.
        /// </summary>
        public Condition() {
        ...
        /// </summary>
        /// <returns>A <see cref="Condition"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Condition CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"inputs", n => { Inputs = n.GetObjectValue<Condition_inputs>(Condition_inputs.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<Condition_inputs>("inputs", Inputs);
