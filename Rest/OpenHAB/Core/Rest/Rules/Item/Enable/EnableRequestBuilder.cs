...
using System;
namespace OpenHAB.Core.Rest.Rules.Item.Enable {
    /// <summary>
    /// Builds and executes requests for operations under \rules\{ruleUID}\enable
    /// </summary>
    public class EnableRequestBuilder : BaseRequestBuilder {
        ...
        public EnableRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rules/{ruleUID}/enable", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="EnableRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EnableRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/rules/{ruleUID}/enable", rawUrl) {
        }
        /// <summary>
