...
namespace OpenHAB.Core.Rest.Addons.Url.Item.Install {
    ...
    public class InstallRequestBuilder : BaseRequestBuilder {
        ...
        public InstallRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/addons/url/{url}/install", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="InstallRequestBuilder"/> and sets the default values.
        /// </summary>
