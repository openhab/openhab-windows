...
namespace OpenHAB.Core.Rest.ChannelTypes.Item.LinkableItemTypes {
    ...
    public class LinkableItemTypesRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new <see cref="LinkableItemTypesRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LinkableItemTypesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/channel-types/{channelTypeUID}/linkableItemTypes", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="LinkableItemTypesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="LinkableItemTypesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        ...
        public class LinkableItemTypesRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
